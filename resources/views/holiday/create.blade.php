    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">Buat Hari Libur</h1>
...
{!! Helper::create_radio('jenis',$jenis,'nasional') !!}
</div>
<div class="form-group">
<label for="holi_date">Tanggal</label>
<input type="text" name="holi_date" id="holi_date" class="form-control"/></div>
<div class="form-group">
<label for="enabled">Tampilkan</label>
{!! Helper::create_radio('enabled',array('Y','N'),'Y') !!}
</div>
<div class="py-3">
