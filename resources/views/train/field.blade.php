            ...
            <div class="row items-push">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="Name" placeholder="Enter a Train Name..">
                    </div>
                    <div class="form-group">
                        <label>Image</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4" placeholder="Description content.."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Train Type</label>
                        <input type="text" class="form-control" name="train_type" placeholder="Enter a Train Type..">
                    </div>
                    <div class="form-group">
                        <label for="">Speed</label>
                        <input type="number" class="form-control" name="speed" placeholder="Enter a Train speed..">
                    </div>
                    <div class="form-group">
                        <label for="">Speed Unit</label>
                        <input type="number" class="form-control" name="speed_unit" placeholder="Enter a Train Speed Unit..">
                    </div>
                    <div class="form-group">
                        <label for="">Enabled</label>
                        <div class="custom-control custom-switch custom-control-lg mb-2">
                            <input type="checkbox" class="custom-control-input" id="example-sw-custom-lg1" name="example-sw-custom-lg1" value="yes">
